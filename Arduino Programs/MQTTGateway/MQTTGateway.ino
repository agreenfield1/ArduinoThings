...
IPAddress TCP_IP ( 10, 20, 30, 31 );				// Configure your static ip-address here
byte TCP_MAC[] = { 0x62, 0x8E, 0x4D, 0xA8, 0x74, 0x48 };	// Mac-address - You should change this! see note *2 above!
